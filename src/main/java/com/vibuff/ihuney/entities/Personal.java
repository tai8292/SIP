...
public class Personal {
    ...
    public Personal(Long id,String firstName, String phoneNumber, String shareholder, Date birthday) {
        this.personalID = id;
    ...
    public Personal(String firstName, String lastName, String middleInitial,
                    ...
                    Long zip, String email, String phoneNumber, String ssn,
                    String driversLicense, String matitalStatus, boolean gender,
                    String shareholder, BenefitPlans benefitPlans, String enthnicity,
                    Date birthday) {
        this.firstName = firstName;
